...
*Note: Status badge colors remain consistent across modes to maintain brand recognition and status meaning.*
...
*Note: Header gradient maintains brand consistency across both modes*
