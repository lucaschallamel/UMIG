...
document.getElementById("debugSessionUsername").textContent = userData.confluenceContextUsername;
...
if (userData && userData.confluenceUserId) {
    document.getElementById("debugDbConfluenceUserId").textContent = userData.confluenceUserId;  // Maps to usr_confluence_user_id
...
<!-- AFTER -->
<div id="loginPage" style="display: none;">  ← ✅ Hidden
  <h2>UMIG Admin Console - Login</h2>
  <!-- ... trigram input, button, etc. ... -->
</div>
```
...
- ✅ Debugging panel appears once (top level only)
...
### ✅ Criterion 2: Exactly 3 Identity Fields
