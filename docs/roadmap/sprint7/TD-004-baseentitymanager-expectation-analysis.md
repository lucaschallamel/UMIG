...
this.filterComponent = await this.orchestrator.createComponent("filter", config);
this.paginationComponent = await this.orchestrator.createComponent("pagination", config);
```
...
// WITH THIS:
if (this.paginationComponent && typeof this.paginationComponent.setState === "function") {
