...
Gemini Code automatically delegates to appropriate agents based on task context. Both GENDEV and Quad agents MUST BE USED proactively when their expertise is relevant.
...
- **Role-Based Access Control**: Complete three-tier permission system (NORMAL/PILOT/ADMIN) with Confluence integration
