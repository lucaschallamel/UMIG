...
- Badge text: ________________________________
- Badge color: ________________________________
- Console messages: ________________________________
...
console.log("Should show badge:", !["NORMAL", "PILOT", "ADMIN"].includes(currentRole));
...
const visibleBadges = Array.from(badges).filter(b => b.offsetWidth > 0).length;
const visibleDropdowns = Array.from(dropdowns).filter(d => d.offsetWidth > 0).length;
...
| Pilot Role | [ ] PASS/FAIL | Dropdown only | _______ | _______ |
| Normal Role | [ ] PASS/FAIL | No controls | _______ | _______ |
| Default User | [ ] PASS/FAIL | Badge only | _______ | _______ |
| Invalid Role | [ ] PASS/FAIL | Badge only | _______ | _______ |
| Edge Cases | [ ] PASS/FAIL | Various | _______ | _______ |
...
**Testing Complete**: ___/___/_____  
