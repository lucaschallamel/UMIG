...
(function() {
    ...
    const UiUtils = {
         ...
         */
        showEmptyState: function(container, message, actionText = null, actionCallback = null) {
         ...
         */
        createSelectOptions: function(items, valueField, textField, placeholder = 'Select...') {
