...
(function () {
  ...
  const StatusColorService = {
     ...
     */
    formatStatusBadge: async function(statusName, entityType = "Step", fallbackColor = "#999999") {
      if (!statusName) return "";
      
      const color = await this.getStatusColor(statusName, entityType) || fallbackColor;
     ...
     */
    applyStatusColors: async function(container = document, entityType = "Step") {
      ...
      elements.forEach(element => {
        ...
        const status = statusMap[statusName] || statusMap[statusName.toUpperCase()];
