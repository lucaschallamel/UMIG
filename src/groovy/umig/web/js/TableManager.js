    ...
    const TableManager = {
        ...
        renderTable: function(data, entityType, container) {
            ...
            if (!tableWrapper) {
                ...
                if (container.classList && container.classList.contains('table-wrapper')) {
                    ...
                    if (existingTable && existingTable.parentElement.classList.contains('table-wrapper')) {
            ...
            if (tableWrapper) {
                ...
                console.warn('No table-wrapper found, looking for alternative update method');
                ...
                if (existingTable) {
                    ...
                    console.error('Warning: Updating entire container - pagination may be lost');
        ...
        buildTableHeader: function(entity) {
            ...
            headerHtml += '<th class="selection-column"><input type="checkbox" class="select-all-checkbox"></th>';
        ...
        buildTableRow: function(row, entity) {
            ...
            entity.tableColumns.forEach(column => {
                ...
                if (column === 'role_display') {
                    ...
                    if (row.usr_is_admin === true || row.usr_is_admin === 'true' || row.usr_is_admin === 1) {
                        ...
                        if (roleName) {
                            ...
                            formattedValue = this.formatRoleDisplay(roleMap[roleId] || 'Unknown');
                        } else {
        ...
        buildActionButtons: function(rowId, entity) {
            const currentEntity = window.AdminGuiState ? window.AdminGuiState.getState().currentEntity : '';
        ...
        formatCellValue: function(value, column, entity) {
            ...
            if (field) {
                switch (field.type) {
                    case 'boolean':
                        return window.UiUtils ? window.UiUtils.formatBoolean(value) : (value ? 'Yes' : 'No');
                    case 'datetime':
            ...
            return window.UiUtils ? window.UiUtils.sanitizeHtml(value.toString()) : value.toString();
        },
        ...
        renderPagination: function(container) {
            ...
            if (pageNumbersContainer) {
                const pageNumbers = this.getPageNumbers(pagination.currentPage, pagination.totalPages);
                let pageNumbersHtml = '';
            ...
            if (pageSizeSelect && pageSizeSelect.value !== pagination.pageSize.toString()) {
