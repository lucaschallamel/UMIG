...
test.describe('Color Picker Functionality', () => {
  ...
  test('should show enhanced color picker in Migration Types CREATE modal', async ({ page }) => {
  ...
  test('should show enhanced color picker in Iteration Types EDIT modal', async ({ page }) => {
  ...
  test('should update color preview when color is changed', async ({ page }) => {
    // Navigate to Migration Types
    await page.click('text=Migration Types');
    await page.waitForSelector('#migrationTypesTable');
