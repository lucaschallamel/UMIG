...
describe('Admin GUI Proxy Pattern and API Resolution', () => {
  ...
  describe('API Endpoint Resolution', () => {
    ...
    test('should have all required API endpoints', () => {
      const requiredEndpoints = [
        ...
        'iterations', 'labels', 'iterationTypes', 'migrationTypes', 
        'migrations', 'stepView'
      ];
    ...
    test('should construct full API URLs correctly', () => {
      ...
      expect(iterationTypesUrl).toBe('/rest/scriptrunner/latest/custom/iterationTypes');
      expect(migrationTypesUrl).toBe('/rest/scriptrunner/latest/custom/migrationTypes');
    });
  });
  ...
  describe('Entity Proxy Pattern - With EntityConfig Available', () => {
      ...
      global.window.EntityConfig = {
        getAllEntities: jest.fn().mockReturnValue({
          ...
          migrationTypes: { 
            ...
            fields: [
              { key: 'mtm_code', label: 'Code', type: 'text' },
              { key: 'mtm_name', label: 'Name', type: 'text' }
            ]
          }
        }),
    ...
    test('should retrieve iterationTypes entity through getEntity method', () => {
      ...
      expect(window.EntityConfig.getEntity).toHaveBeenCalledWith('iterationTypes');
    ...
    test('should retrieve migrationTypes entity through getEntity method', () => {
      ...
      expect(window.EntityConfig.getEntity).toHaveBeenCalledWith('migrationTypes');
    ...
    test('should return null for non-existent entity', () => {
      ...
      expect(window.EntityConfig.getEntity).toHaveBeenCalledWith('nonExistentEntity');
  ...
  describe('Backward Compatibility', () => {
    test('should maintain API endpoint structure for backward compatibility', () => {
      ...
      const legacyEndpoints = ['users', 'teams', 'environments', 'applications', 'migrations'];
