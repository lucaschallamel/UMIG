...
function main() {
  try {
    ...
    const existingSecurityCount = (content.match(/^      security:/gm) || [])
      .length;
    ...
    const newSecurityCount = (cleanedContent.match(/^      security:/gm) || [])
      .length;
    ...
    console.log(
      `✅ Successfully removed ${removed} duplicate security definitions`,
    );
