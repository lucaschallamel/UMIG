...
window.debugDatabaseVersionManager = {
    ...
    checkSecureMode() {
        ...
        console.log('- Initialization Errors:', dvm.securityState?.initializationErrors || []);
        ...
        try {
            ...
            console.log('- Method source:', dvm.generateSQLPackage.toString().substring(0, 100) + '...');
        } catch (e) {
    ...
    async testMethods() {
        ...
        try {
            ...
            console.log('✅ Liquibase Package generation successful:', liquibaseResult);
        } catch (error) {
    ...
    async runDiagnostic() {
        ...
        console.log('2. If API endpoints return 404, check ScriptRunner registration');
        console.log('3. If methods are overridden, try forceReinitialize() (test only)');
        console.log('4. Check browser network tab when clicking buttons');
    }
};

console.log('✅ Debug utilities loaded. Run: debugDatabaseVersionManager.runDiagnostic()');